...
<header id="home" class="header">
    <nav class="nav" role="navigation">
        <div class="container nav-elements">
            ...
            <ul class="navbar">
                <li><a href="/home"><spring:message code="label.home"></spring:message></a></li>
                <li><a href="/goToLogin"><spring:message code="label.search"></spring:message></a></li>
                <li><a href="/goToSearch"><spring:message code="label.login"></spring:message></a></li>
                <li><a href="/redirectToLinkedIn"><spring:message code="label.linkedin"></spring:message></a></li>
            </ul><!-- navbar -->
